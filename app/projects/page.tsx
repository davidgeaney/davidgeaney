...
const projects = [
  ...
  },
  {
    ...
    description:
      "A modern website for a professional plumbing service, featuring a clean design that emphasizes trust and reliability. The project included developing a comprehensive service showcase and an efficient booking system.",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/proplumbportfolio.jpg-qtv98UNjcHowDd3i1TbvwUpGnENyc0.jpeg",
    timeframe: "1 week",
    year: "2024",
    role: "Web Designer",
    deliverables: ["Website Design", "Service Catalog", "Booking Integration", "Mobile Optimization"],
    website: "https://proplumb.vercel.app",
  },
  {
    id: 4,
    title: "STRAND ROAD",
    ...
    description:
      "An elegant website for a premium dining establishment, highlighting the restaurant's unique atmosphere and culinary offerings. The design focuses on creating an appetizing visual experience that reflects the quality of the venue.",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/strandportfolioimg.jpg-DNRL4L5iQMTHDZcj6DKh112RbhL5hW.jpeg",
    timeframe: "2 weeks",
    year: "2024",
    role: "Designer & Developer",
    deliverables: ["Website Design", "Menu System", "Reservation Integration", "Photo Direction"],
    website: "https://strandroadbarandkitchen.vercel.app",
  },
]
